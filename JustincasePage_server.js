            ...
            <div className="result-section">
              ...
              <div className="result-item-split">
                ...
                <span className="result-value-right">
                  {formatNumber(Math.round(resultData.deathPremium || (resultData.basePremium * 0.9) || 0))} руб.
                </span>
              </div>
              ...
              <div className="result-item-split">
                ...
                <span className="result-value-right">
                  {formatNumber(Math.round(resultData.disabilityPremium || (resultData.basePremium * 0.1) || 0))} руб.
                </span>
              </div>
              ...
              <div className="result-item-split">
                ...
                <span className="result-value-right">
                  {formatNumber(resultData.baseInsuranceSum || parseUserSum(resultData.insuranceSum))} руб.
                </span>
              </div>
              <div className="result-item-split">
              ...
              {resultData.accidentPackageIncluded ? (
                <>
                  ...
                  <div className="result-item-split">
                    ...
                    <span className="result-value-right">
                      {formatNumber(resultData.accidentInsuranceSum || parseUserSum(resultData.insuranceSum))} руб.
                    </span>
                  </div>
                </>
              ) : (
