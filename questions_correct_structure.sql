-- 25 русских вопросов для Assessment (правильная структура полей)
...
(1, 'В каких условиях вы лучше всего проявляете себя в работе?', 1, 'multiple_choice', true);
...
-- Вопрос 2
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы реагируете на неожиданные изменения в проекте?', 2, 'multiple_choice', true);
...
-- Вопрос 3
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Если коллега критикует ваш подход к задаче, как вы отреагируете?', 3, 'multiple_choice', true);
...
-- Вопрос 4
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Что для вас важнее при получении обратной связи?', 4, 'multiple_choice', true);
...
-- Вопрос 5
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'При работе в команде, где мнения расходятся, вы склонны:', 5, 'multiple_choice', true);
...
-- Вопрос 7
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы относитесь к налаживанию связей с коллегами?', 7, 'multiple_choice', true);
...
-- Вопрос 8
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'При планировании проекта что для вас приоритетнее?', 8, 'multiple_choice', true);
...
-- Вопрос 9
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы относитесь к совместной работе над сложными задачами?', 9, 'multiple_choice', true);
...
-- Вопрос 10
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы подходите к участию в корпоративных мероприятиях?', 10, 'multiple_choice', true);
...
-- Вопрос 11
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Когда вы изучаете что-то новое для работы?', 11, 'multiple_choice', true);
...
-- Вопрос 12
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как глубоко вы изучаете новую информацию?', 12, 'multiple_choice', true);
...
-- Вопрос 13
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы делитесь знаниями с коллегами?', 13, 'multiple_choice', true);
...
-- Вопрос 14
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы относитесь к пересмотру существующих процессов?', 14, 'multiple_choice', true);
...
-- Вопрос 15
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как часто вы изучаете новинки в своей области?', 15, 'multiple_choice', true);
...
-- Вопрос 16
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Когда вы обращаетесь за помощью к коллегам?', 16, 'multiple_choice', true);
...
-- Вопрос 17
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы подходите к анализу результатов?', 17, 'multiple_choice', true);
...
-- Вопрос 18
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'В каких ситуациях вы чувствуете себя наиболее продуктивно?', 18, 'multiple_choice', true);
...
-- Вопрос 19
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Что означает для вас "успешно выполненная работа"?', 19, 'multiple_choice', true);
...
-- Вопрос 20
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как вы относитесь к предложениям по улучшению?', 20, 'multiple_choice', true);
...
-- Вопрос 21
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Какие изменения в рабочем процессе вы готовы поддержать?', 21, 'multiple_choice', true);
...
-- Вопрос 22
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Какая обратная связь вас больше мотивирует?', 22, 'multiple_choice', true);
...
-- Вопрос 23
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Как часто вы вносите изменения в привычные процессы?', 23, 'multiple_choice', true);
...
-- Вопрос 24
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'Что для вас важнее в работе?', 24, 'multiple_choice', true);
...
-- Вопрос 25
INSERT INTO questions (questionnaire_id, text, order_index, question_type, is_required) VALUES 
(1, 'На что вы больше обращаете внимание при завершении проекта?', 25, 'multiple_choice', true);
